        ...
        <div id="overlay" class="absolute inset-0 flex items-center justify-center z-10 transition-opacity duration-500 bg-black bg-opacity-50">
            <div class="text-center p-8 rounded-lg">
                ...
                <h2 class="text-white text-2xl font-semibold mb-4">
                    De la photo {{ $photoType->name }}, Super ! <br>
                    Tu vas devoir choisir parmi 3 séries de 3 photos celle que tu préfères en termes de couleurs.
                </h2>
                <p class="text-white mb-6">
                    C’est ce qui va déterminer la marque de ton appareil photo.
                </p>
            ...
            <form action="{{ route('simulation.post-step-one', ['simulation' => $simulation]) }}" method="POST">
                ...
                <div class="relative">
                    ...
                    <div id="series-{{ $groupIndex }}" class="series hidden">
                        <div class="flex justify-center gap-4">
                            ...
                            <div class="photo-item cursor-pointer" style="width: 668px; height: 422px;" onclick="selectPhoto({{ $photo->id }}, {{ $groupIndex }})">
                ...
                <div class="flex justify-between items-center mt-6">
                    <button type="button" id="prevButton"
                        class="text-infocus-icewhite border border-infocus-icewhite py-2 px-4 rounded transition" disabled>
                        Précédent
                    </button>

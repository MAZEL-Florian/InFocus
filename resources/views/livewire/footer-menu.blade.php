<!-- Footer -->
<footer class="text-center text-lg-start bg-gray-700 text-white mt-auto">
            ...
            <div class="text-center md:text-left mt-5">
                ...
                <div class="flex flex-wrap justify-center mt-3">
                    ...
                    <div class="w-full md:w-1/4 lg:w-1/5 xl:w-1/6 mx-auto mb-4">
                        <!-- Content -->
                        <h6 class="uppercase font-bold mb-4">
                            <i class="fas fa-gem"></i> Accueil
                        </h6>
                        <p>
                        ...
                        <p>
                            <a href="{{ route('product.index') }}" class="text-reset no-underline">Nos produits</a>
                        </p>
                        <p>
                    ...
                    <div class="w-full md:w-1/2 lg:w-2/5 xl:w-1/3 mx-auto mb-4">
                        <!-- Links -->
                        <h6 class="uppercase font-bold mb-4">Inscris-toi à notre Newsletter</h6>
                        <p><i class="fas fa-home"></i>Recevez notre newsletter mensuelle pour obtenir des conseils utiles sur la photographie </p>
                        <p>
                        ...
                        <!-- RESEAUX SOCIAUX -->
                        <h6 class="uppercase font-bold mb-4">Réseaux sociaux</h6>
